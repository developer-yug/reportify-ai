...
# variables as False so later code that references them does not fail.
...
# --- Tabs ---
tab1, tab2, tab3 = st.tabs(["📋 Task Allocation", "💻 Workfolio Activity", "📊 Admin Dashboard"])
...
# AI Summary tab removed per user request
